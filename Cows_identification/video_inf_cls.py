...
def classify_videos(test_videos_path, cls_model, seg_model, num_frames, time_interval, model_size, trained_model_path=None):
        ...
        if files:
            ...
            for index, file in enumerate(files, start=1):
                if file.endswith(('.MP4')):
                    ...
                    top5 = yolo_predict(video_path, masked_images, cls_model)
